...
public class ParserTest
{
    ...
    {
        Parser parser;
        parser = new Parser( "http://repository@id=repo1!group/artifact@id=repo1" );
    ...
    public void urlWithRepositoryAndGroupArtifact()
        throws MalformedURLException
    {
        Parser parser = new Parser( "http://repository@id=repo1!group/artifact" );
    ...
    public void urlWithRepositoryAndGroupArtifactVersionType()
        throws MalformedURLException
    {
        Parser parser = new Parser( "http://repository@id=repo1!group/artifact/version/type" );
        assertEquals( "Group", "group", parser.getGroup() );
        assertEquals( "Artifact", "artifact", parser.getArtifact() );
    ...
    public void urlWithRepositoryAndGroupArtifactVersionTypeClassifier()
        throws MalformedURLException
    {
        Parser parser = new Parser( "http://repository@id=repo1!group/artifact/version/type/classifier" );
        assertEquals( "Group", "group", parser.getGroup() );
        assertEquals( "Artifact", "artifact", parser.getArtifact() );
        assertEquals( "Version", "version", parser.getVersion() );
        assertEquals( "Type", "type", parser.getType() );
    ...
    public void urlWithJarRepository()
        throws MalformedURLException
    {
        Parser parser = new Parser( "jar:http://repository/repository.jar!/@id=repo1!group/artifact/0.1.0" );
